...
load_CN()
{
    resetprop "ro.product.model" "Honor 50X"
    resetprop "ro.product.odm.model" "Honor 50X"
    resetprop "ro.product.system.model" "Honor 50X"
    resetprop "ro.product.vendor.model" "Honor 50X"
    resetprop "ro.product.system_ext.model" "Honor 50X"
    resetprop "ro.product.product.model" "Honor 50X"
